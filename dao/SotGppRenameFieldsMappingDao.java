...
public interface SotGppRenameFieldsMappingDao extends JpaRepository<SotGppRenameFieldsMapping, Integer> {
    ...
    SotGppRenameFieldsMapping findBySotFieldDetailsAndGppFieldDetails(@Param("sotFieldDetails") SotFieldDetails sotFieldDetails,
    ...
    List<SotGppRenameFieldsMapping> searchBySotAndGppRename(
            @Param("sotRenameParam") String sotRenameParam,
